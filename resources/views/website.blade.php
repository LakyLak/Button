...
<head>
    ...
    <!-- CSS
    ================================================== -->
    {{-- <link rel="stylesheet" href="../frontend/css/custom_css.css"> --}}
...
<body id="top">
    ...
    <header class="s-header">
        ...
        <div class="header-logo">
            <a class="site-logo" href="index.html">
                <img src="frontend/images/logo.svg" alt="Homepage">
            </a>
        </div> <!-- end header-logo -->
    ...
    <!-- home
    ================================================== -->
    {{-- <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="../frontend/images/hero-bg.jpg"  --}}
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="../frontend/images/button.jpg" 
    data-natural-width=3000 data-natural-height=2000 data-position-y=top>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <p>
                Something meaningful as a motto <br>
                that will help the eshop stand out.
                </p>
            </div> <!-- end home-content__main -->

        </div> <!-- end home-content -->

        {{-- TODO to put something meaningfull three items is enough --}}
        <ul class="home-sidelinks">
            <li><a class="smoothscroll" href="#menu_1">menu_1<span>menu_1 short desc.</span></a></li>
            <li><a class="smoothscroll" href="#menu_2">menu_2<span>menu_2 short desc.</span></a></li>
            <li><a class="smoothscroll" href="#menu_3">menu_3<span>menu_3 short desc.</span></a></li>
            <li><a class="smoothscroll" href="#menu_4">menu_4<span>menu_4 short desc.</span></a></li>
            <li><a class="smoothscroll" href="#menu_5">menu_5<span>menu_5 short desc.</span></a></li>
            ...
            <div class="masonry">
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__thumb">
                            <a href="../frontend/images/portfolio/gallery/g-lamp.jpg" class="thumb-link" title="Lamp" data-size="1050x700">
                                <img src="../frontend/images/portfolio/lamp.jpg" 
                                     srcset="../frontend/images/portfolio/lamp.jpg 1x, ../frontend/images/portfolio/lamp@2x.jpg 2x" alt="">
                            </a>
                        </div>
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__thumb">
                            <a href="../frontend/images/portfolio/gallery/g-salad.jpg" class="thumb-link" title="Salad" data-size="1050x700">
                                <img src="../frontend/images/portfolio/salad.jpg" 
                                     srcset="../frontend/images/portfolio/salad.jpg 1x, ../frontend/images/portfolio/salad@2x.jpg 2x" alt="">
                            </a>
                        </div>
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__thumb">
                            <a href="../frontend/images/portfolio/gallery/g-woodcraft.jpg" class="thumb-link" title="Woodcraft" data-size="1050x700">
                                <img src="../frontend/images/portfolio/woodcraft.jpg"
                                     srcset="../frontend/images/portfolio/woodcraft.jpg 1x, ../frontend/images/portfolio/woodcraft@2x.jpg 2x" alt="">
                            </a>
                        </div>
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__thumb">
                            <a href="../frontend/images/portfolio/gallery/g-liberty.jpg" class="thumb-link" title="Liberty" data-size="1050x700">
                                <img src="../frontend/images/portfolio/liberty.jpg"
                                     srcset="../frontend/images/portfolio/liberty.jpg 1x, ../frontend/images/portfolio/liberty@2x.jpg 2x" alt="">
                            </a>
                        </div>
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__thumb">
                            <a href="../frontend/images/portfolio/gallery/g-fuji.jpg" class="thumb-link" title="Fuji" data-size="1050x700">
                                <img src="../frontend/images/portfolio/fuji.jpg"
                                     srcset="../frontend/images/portfolio/fuji.jpg 1x, ../frontend/images/portfolio/fuji@2x.jpg 2x" alt="">
                            </a>
                        </div>
                ...
                <div class="masonry__brick" data-aos="fade-up">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__thumb">
                            <a href="../frontend/images/portfolio/gallery/g-shutterbug.jpg" class="thumb-link" title="Shutterbug" data-size="1050x700">
                                <img src="../frontend/images/portfolio/shutterbug.jpg"
                                     srcset="../frontend/images/portfolio/shutterbug.jpg 1x, ../frontend/images/portfolio/shutterbug@2x.jpg 2x" alt="">
                            </a>
                        </div>
            ...
            <div class="row testimonials">
                ...
                <div class="col-full testimonials__slider">
                    ...
                    <div class="testimonials__slide">
                        <img src="../frontend/images/avatars/user-01.jpg" alt="Author image" class="testimonials__avatar">
                    ...
                    <div class="testimonials__slide">
                        <img src="../frontend/images/avatars/user-05.jpg" alt="Author image" class="testimonials__avatar">
                    ...
                    <div class="testimonials__slide">
                        <img src="../frontend/images/avatars/user-02.jpg" alt="Author image" class="testimonials__avatar">
